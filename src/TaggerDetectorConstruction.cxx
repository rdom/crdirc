...
G4double CO2photonEnergy[27] = { 
1.78*eV, 1.82*eV, 1.86*eV, 1.91*eV, 1.95*eV,
2*eV,    2.05*eV, 2.1*eV,  2.16*eV, 2.22*eV,
2.28*eV, 2.34*eV, 2.41*eV, 2.49*eV, 2.56*eV,
2.65*eV, 2.74*eV, 2.83*eV, 2.93*eV, 3.04*eV,
3.16*eV, 3.28*eV, 3.42*eV, 3.57*eV, 3.73*eV,
3.91*eV, 4.11*eV
};
...
// there is NOTHING in the web which says anything about the absorption length of CO2 in the visible range
